...
{
    [Entity(TableCnName = "项目历史", TableName = "ProjectHistory")]
    public partial class ProjectHistory : BaseEntity
    {
        ...
        /// <summary>
        /// 操作状态 (0:默认状态,1：已提交,2：草稿待提交,3:变更待提交)
        /// </summary>
        ...
        /// <summary>
        /// 审批状态 (0:默认状态,1:审核通过,2:审核中,3:审核未通过,4:审核驳回,5:审批撤回(发起人主动发起))
        /// </summary>
        ...
        /// <summary>
        /// 项目状态 (0:默认状态,1:进行中,2:正常结项,3:未开始)
        /// </summary>
        ...
        /// <summary>
        /// 变更来源
        /// <para>非2:合同变更 保存</para>
        /// <para>2:项目变更 保存</para>
        /// </summary>
        [Display(Name = "ChangeSource")]
        [Column(TypeName = "tinyint")]
        [Editable(true)]
        [Required(AllowEmptyStrings = false)]
        public byte ChangeSource { get; set; }
