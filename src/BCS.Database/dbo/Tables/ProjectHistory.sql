CREATE TABLE [dbo].[ProjectHistory] (
    ...
    [Contract_Project_Relationship] NVARCHAR (50)   NOT NULL DEFAULT (''),---合同项目对应关系
    ...
    [Project_TypeId]                INT   NOT NULL DEFAULT (-1),---项目类型Id
    ...
    [Operating_Status] TINYINT  DEFAULT (0) NOT NULL,--操作状态 (0:草稿,1：已提交,2：草稿待提交,3:变更待提交)
    [Approval_Status] TINYINT DEFAULT (0) NOT NULL,--审批状态 (1:审批通过,2:审批驳回,3:审批中 ,4:未发起 ,5:已撤回)
    [Project_Status] TINYINT DEFAULT (0) NOT NULL,--项目状态 (1:进行中,2:正常结项)
    ...
    [ChangeSource] TINYINT NOT NULL DEFAULT(0),--1:合同变更，2：项目变更
    [CreateTime]                    DATETIME        NOT NULL DEFAULT('1900-01-01'),---备份时间
    [ContractVersion]                       INT         NOT NULL DEFAULT ((0)),--项目变更历史关联-合同版本号
