CREATE TABLE [dbo].[SubContractFlowStaff] (  --分包人员流程列表
    [Id]                            INT           IDENTITY (1, 1) NOT NULL,---主键自增ID
    [SubContractFlowId]             INT             NULL DEFAULT -1, -- 流程Id
    [SubContractStaffId]            INT             NOT NULL DEFAULT -1, -- 分包人员Id
    ...
    CONSTRAINT [PK_SubContractFlowStaff] PRIMARY KEY CLUSTERED ([Id] ASC)
);
