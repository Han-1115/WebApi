...
namespace BCS.System.Controllers
{
    ...
    public partial class Sys_UserController
    {
        ...
        public IActionResult ReplaceToken()
        {
            ...
            try
            {
                ...
                lock (_obj)
                {
                    ...
                    if (userInfo == null) return Json(responseContent.Error("No user information found!"));
            ...
            catch (Exception ex)
            {
                ...
                responseContent.Error("Token replacement exception");
            }
            finally
            {
        ...
        public IActionResult GetPagerList([FromBody] PageDataOptions pageDataOptions) => Json(Service.GetPagerList(pageDataOptions).Result);
        ...
        /// <returns></returns>
        [HttpGet, Route("GetUsersByRole")]
        public IActionResult GetUsersByRole(string roleName) => Json(Service.GetUsersByRole(roleName).Result);
