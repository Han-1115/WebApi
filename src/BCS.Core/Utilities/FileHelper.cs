...
namespace BCS.Core.Utilities
{
    public class FileHelper
    {
        ...
        public static (string absolutePath, string relativePath) GetExportFilePath(string contentRootPath, string type)
        {
            string folder = DateTime.Now.ToString("yyyyMMdd");
            string savePath = $"Download/ExcelExport/{folder}/";
            string fileName = $"{type}_{DateTime.Now.ToString("yyyyMMddHHssmm")}_.xlsx";
