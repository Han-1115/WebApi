...
namespace BCS.Core.ManageUser
{
    public class UserContext
    {
        ...
        public UserInfo GetUserInfo(int userId)
        {
            ...
            _userInfo.RoleName = DBServerProvider.DbContext.Set<Sys_Role>().Where(s => s.Role_Id == _userInfo.Role_Id).Select(s => s.RoleName).FirstOrDefault();
